            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li v-if="userRoles === 'jefe'" class="nav-item">
                <router-link
                  class="nav-link text-white text-uppercase"
                  to="/importacionhoras"
                  ><i class="fa-solid fa-file-arrow-up"></i> Agregar horas
                  extras
                </router-link>
              </li>
              <li v-if="userRoles === 'jefe'" class="nav-item">
              ...
              <li v-if="userRoles === 'administrador'"  class="nav-item">
                <router-link
                  class="nav-link text-white text-uppercase"
                  to="/historialhoras"
                  ><i class="fa-brands fa-searchengin"></i> Historial horas
                  extras</router-link
                >
              </li>
              <li v-if="userRoles === 'administrador'" class="nav-item">
                <router-link
                  ...
                  ><i class="fa-brands fa-file-circle-check"></i> Selecci&#243;n
                  archivo</router-link
                >
              </li>
            </ul>
    ...
    <div class="d-flex flex-row">
      ...
      >
        <ul class="ul">
          ...
          <li v-if="userRoles === 'jefe'" class="li my-4">
            <router-link class="my-4 text-uppercase" to="/editarperfilusuario"
