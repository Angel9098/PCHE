<template>
  <div>
    ...
    <p class="zoom-area">
        Lamentablemente, la página que estás buscando no se encuentra disponible en este momento. Puede ser que la dirección haya cambiado o que la página haya sido eliminada. Por favor, verifica la URL o regresa a la página de inicio.
    </p>
